...
public class CustomAdapterSelectFiles extends RecyclerView.Adapter<CustomAdapterSelectFiles.RecycleViewHolder> {
    private final String TAG = CustomAdapterSelectFiles.class.getSimpleName();

    private OnClickedListener onClickedListener;
    private Context context;
    private List<File> listFile;

    public CustomAdapterSelectFiles(OnClickedListener onClickedListener, Context context, List<File> listFile) {
